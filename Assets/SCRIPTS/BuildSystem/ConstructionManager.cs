...
public class ConstructionManager : MonoBehaviour
{
    ...
    public Material ghostFullTransparentMat;    // actual
    ...
    private void PlaceItemInGhostPosition(GameObject copyOfGhost)
    {
        ...
        var randomOffset = UnityEngine.Random.Range(0.01f, 0.03f);      // 避免模型重叠
 
        itemToBeConstructed.transform.position = ghostPosition + new Vector3(randomOffset, 0, randomOffset);
        ...
        else
        {
            ...
            DestroyItem(selectedGhost);     // delete the wallGhost
        }
    ...
    private void PlaceItemFreeStyle()
    {
        // Setting the parent to be the root of our scene
        itemToBeConstructed.transform.SetParent(transform.parent.transform.parent, true);
        itemToBeConstructed.transform.rotation = Quaternion.identity;
